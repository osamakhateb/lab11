...
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/1.png)
* Создал текстовой файл *lab11_1.sh*, используя команду *touch*. Открываю текстовой редактор *emacs*.
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/2.png)
...
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/3.png)

* Командой *chomad* я сделал так, чтобы файл был исполняемым в **Linux**. 

![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/4.png)

* Проверяю, смог ли выполнить мою программу. Папка с именем *backup* была создана.
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/5.png)

* Проверяю, смог ли выполнить мою программу.

![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/6.png)

* Проверяю, смог ли выполнить мою программу.
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/7.png)
...
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/8.png)


* Написал программу, для вывода того, что я буду вводить.
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/9.png)
...
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/10.png)
...
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/11.png)


*  Написал командный файл — аналог команды ls (без использования самой этой команды и команды dir).
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/12.png)

*  Он выдавал информацию о нужном каталоге и выводил информацию о возможностях доступа к файлам этого каталога.
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/13.png)


4. Создал текстовой файл *lab11_2.sh*(для выполнения 2 пункта данной лабораторной работы), используя команду *touch*. Открываю текстовой редактор *emacs*.
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/14.png)


* Написал командный файл, который получает в качестве аргумента командной строки формат файла (.txt, .doc, .jpg,  pdf и т.д.).
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/15.png)
...
![](https://raw.githubusercontent.com/osamakhateb/lab11/main/image/16.png)
